...

{
    ...
    echo "Git commit:     pre-squash PR source tree"
    echo "Dataset:        $DATASET"
    echo "Dirty tree:     $DIRTY (excluding this generated output)"
    echo "Artifact provenance: generated by make false-sharing-study from the current PR source tree; rerun after squash merge to bind metadata to the merged commit."
