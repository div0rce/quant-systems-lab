...

{
    ...
    echo "Source tree:    $(qsl_source_tree_hash_excluding "$OUT") (tracked files, excluding output)"
    echo "Dataset:        $DATASET"
    echo "Dirty tree:     $DIRTY (excluding this generated output)"
    echo "Artifact provenance: generated by make false-sharing-study from the Git commit and source tree above with only this output excluded from the dirty-tree check."
