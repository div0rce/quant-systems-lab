...
A running, honest record of external feedback on Quant Systems Lab and what was done about it.
It is the companion to the [external review request](review_request.md).

## Status

> **No external review has been received yet.**
>
...
```markdown
### YYYY-MM-DD, <reviewer or "anonymous">

- **Area:** <e.g. SPSC memory ordering / socket profiling methodology>
- **Criticism:** <what they said was wrong or unclear>
- **Disposition:** accepted | partially accepted | rejected
- **Rationale:** <why>
- **Follow-up:** <issue #, PR #, commit, or "none needed">
```
