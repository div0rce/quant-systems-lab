...
- **Last action:** project brain files prepared: `CLAUDE.md`, `HANDOFF.md`, `MILESTONES.md`, `PROGRESS.md`
...
|---|---|---|---|---|---|
| M0 | Scaffold, tooling, CI | `feat/m00-scaffold` | ☐ not started | — | Create repo structure, CMake, CI, Claude commands |
