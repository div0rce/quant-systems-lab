...
- **Last action:** fixed PR #114 review feedback on NUMA evidence classification/provenance,
  regenerated the constrained Docker artifact from clean source commit 4e7c598, and re-ran
  verification.
