...
- **Last action:** fixed the remaining PR #114 review feedback on `numactl` topology fallback and
  unsupported-host artifacts through `make numa-study`, regenerated the constrained Docker artifact
  from clean source commit d77c98a, and re-ran verification.
