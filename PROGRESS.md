...
- **Last action:** completed M35 (multi-client TCP load script + artifact + docs), applied /code-review fixes, and opened PR #100 (`test: add multi-client socket pressure coverage`).
