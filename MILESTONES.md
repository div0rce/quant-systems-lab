...
- [x] Benchmark artifacts are generated by committed scripts and include metadata.
- [x] Docs state what allocation/layout changed and what did not.
- [x] Negative or slower results are documented honestly.
- [x] No speedup/cache-locality claim without measured evidence.
- [x] `make check` passes; `PROGRESS.md` updated.
